<?php
// ============================================
// MIS PEDIDOS — DEPARTAMENTO DE VENTAS
// ============================================
...
<head>
    ...
    <title>Mis Pedidos — Ventas | SportStore</title>
...
<body>
    <div class="sidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <a href="mis_pedidos.php" class="menu-item active">
    ...
    <div class="main-content">
        <div class="admin-header">
            <h1><i class="fas fa-bag-shopping"></i> Mis Pedidos</h1>
            <div class="user-info">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Aquí aparecerán todos los pedidos asignados a tu cartera de clientes.</p>
                        </div>
                    </div>
                </div>
            </div>

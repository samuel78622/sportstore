<?php
// ============================================
// CUPONES — DEPARTAMENTO DE VENTAS
// ============================================
...
<head>
    ...
    <title>Cupones — Ventas | SportStore</title>
...
<body>
    <div class="sidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <a href="cupones.php" class="menu-item active">
    ...
    <div class="main-content">
        <div class="admin-header">
            <h1><i class="fas fa-tag"></i> Gestión de Cupones</h1>
            <div class="user-info">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0">Cupones Disponibles</h5>
                        </div>
                        <div class="card-body">
                            <p class="text-muted">Aquí podrás ver y gestionar los cupones disponibles para ofrecer a tus clientes.</p>
                        </div>
                    </div>
                </div>
            </div>

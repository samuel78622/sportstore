<?php
// ============================================
// MIS VENTAS — DEPARTAMENTO DE VENTAS
// ============================================
...
<head>
    ...
    <title>Mis Ventas — Ventas | SportStore</title>
...
<body>
    <div class="sidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <a href="mis_ventas.php" class="menu-item active">
                    ...
                    <div class="card card-stats">
                        <div class="card-body">
                            ...
                            <div class="stat-content">
                                <h6>Monto Total</h6>
                                <h3>$8,450.00</h3>
                                <small class="text-info">Generado</small>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Aquí irá el reporte detallado de tus ventas realizadas.</p>
                        </div>
                    </div>
                </div>
            </div>

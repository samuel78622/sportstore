<?php
// ============================================
// CLIENTES — DEPARTAMENTO DE VENTAS
// ============================================
...
<head>
    ...
    <title>Clientes — Ventas | SportStore</title>
...
<body>
    ...
    <div class="main-content">
        <div class="admin-header">
            <h1><i class="fas fa-user-tie"></i> Mis Clientes</h1>
            <div class="user-info">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0">Mi Cartera de Clientes</h5>
                        </div>
                        <div class="card-body">
                            <p class="text-muted">Aquí aparecerá la lista de clientes asignados a tu cartera.</p>
                        </div>
                    </div>
                </div>
            </div>

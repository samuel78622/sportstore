<?php
// ============================================
// VENTAS — DEPARTAMENTO DE CONTABILIDAD
// ============================================
...
<head>
    ...
    <title>Ventas — Contabilidad | SportStore</title>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0">Reporte de Ventas del Mes</h5>
                        </div>
                        <div class="card-body">
                            <p class="text-muted">Aquí irán los datos de ventas, gráficos y análisis de ingresos por producto.</p>
                            <!-- Aquí irán tablas, gráficos, etc. -->
                        </div>
                    </div>
                </div>
            </div>

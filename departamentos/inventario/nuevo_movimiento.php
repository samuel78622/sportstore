<?php
// ============================================
// NUEVO MOVIMIENTO — DEPARTAMENTO INVENTARIO
// ============================================
...
<head>
    ...
    <title>Nuevo Movimiento — Inventario | SportStore</title>
...
<body>
    <div class="sidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <a href="nuevo_movimiento.php" class="menu-item active">
    ...
    <div class="main-content">
        <div class="admin-header">
            <h1><i class="fas fa-plus-circle"></i> Registrar Nuevo Movimiento</h1>
            <div class="user-info">
                ...
                <div class="col-md-8 offset-md-2">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0">Nuevo Movimiento de Inventario</h5>
                        </div>
                        <div class="card-body">
                            <p class="text-muted">Aquí podrás registrar una nueva entrada o salida de inventario.</p>
                        </div>
                    </div>
                </div>
            </div>

<?php
// ============================================
// STOCK GENERAL — DEPARTAMENTO INVENTARIO
// ============================================
...
<head>
    ...
    <title>Stock General — Inventario | SportStore</title>
...
<body>
    <div class="sidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <a href="stock_general.php" class="menu-item active">
    ...
    <div class="main-content">
        <div class="admin-header">
            <h1><i class="fas fa-warehouse"></i> Stock General</h1>
            <div class="user-info">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Aquí aparecerá el listado completo del stock disponible en bodega.</p>
                        </div>
                    </div>
                </div>
            </div>

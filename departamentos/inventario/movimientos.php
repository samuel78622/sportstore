<?php
// ============================================
// MOVIMIENTOS — DEPARTAMENTO INVENTARIO
// ============================================
...
<head>
    ...
    <title>Movimientos — Inventario | SportStore</title>
...
<body>
    ...
    <div class="main-content">
        <div class="admin-header">
            <h1><i class="fas fa-arrows-up-down"></i> Movimientos de Inventario</h1>
            <div class="user-info">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Aquí aparecerá el registro de todas las entradas y salidas de inventario.</p>
                        </div>
                    </div>
                </div>
            </div>
